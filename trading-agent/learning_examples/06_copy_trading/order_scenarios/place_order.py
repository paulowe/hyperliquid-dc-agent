...
ORDER_SIZE = 3.1  # Size to meet minimum $10 USDC requirement
    ...
    try:
        ...
        if len(spot_data) >= 2:
            ...
            if pair_index < len(asset_ctxs):
                ...
                order_size, order_price = format_order(ORDER_SIZE, order_price, sz_decimals=sz_decimals, is_spot=True, is_buy=True)
