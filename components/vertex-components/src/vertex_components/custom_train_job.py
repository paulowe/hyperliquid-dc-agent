...
def custom_train_job(
    ...
    cmd_args = [
        ...
        f"--hparams={hp_json}",
        f"--predictions_output_uri={predictions.uri}",
    ]
    ...
    if load_to_bq:
        cmd_args.append(f"--bq_project={project_id}")
        cmd_args.append(f"--bq_dataset={dataset_id}")
        cmd_args.append(f"--bq_table={table_id}")
        cmd_args.append(f"--bq_location={project_location}")
        cmd_args.append(f"--bq_write_disposition=WRITE_TRUNCATE")
        cmd_args.append(f"--load_to_bq={load_to_bq}")
