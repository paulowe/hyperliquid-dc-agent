...
def lookup_model(
    ...
    "Outputs",
    [("model_resource_name", str), ("model_uri", str), ("training_dataset", dict)],
):
    """
    ...
    if len(models) == 0:
        ...
        model_uri = getattr(target_model, "uri", None) or getattr(
            target_model.gca_resource, "artifact_uri", ""
        )
    ...
    return model_resource_name, model_uri, training_dataset
