...
def tf_data_splitter(
    ...
    def _to_example(row_dict: dict) -> bytes:
        ...
        start_time_str = str(row_dict["start_time"])
        load_time_str = str(row_dict["load_time_toronto"])

        feat = {
            "start_time": _bytes_feature(start_time_str.encode("utf-8")),
            "load_time_toronto": _bytes_feature(load_time_str.encode("utf-8")),
        }
    ...
    # -----------------------------------------
    _scale_and_write_tfrecords(train_df, train_data.path, "train")
